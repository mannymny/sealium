export const featureCardStyles = {
  ...
  inputIcon: "absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-muted-foreground",
  ...
  upload: "border-2 border-dashed border-border rounded-lg p-6 sm:p-8 text-center bg-muted/20 hover:bg-muted/30 transition-colors cursor-pointer",
